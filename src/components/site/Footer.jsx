        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-8">
          ...
          <div>
            ...
            <div className="flex gap-5 mt-8">
              <a href="https://www.instagram.com/alignedlau/" target="_blank" rel="noopener noreferrer" className="text-ivory/60 hover:text-ivory transition" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/in/ljthomas/" target="_blank" rel="noopener noreferrer" className="text-ivory/60 hover:text-ivory transition" aria-label="LinkedIn">
