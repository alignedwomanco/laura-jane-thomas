      ...
      <div className="relative">
        {aboutCards.map((s) => (
          ...
          >
            ...
            {/* Body */}
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", maxWidth: "880px", margin: "0 auto", paddingTop: "48px", paddingBottom: s.zIndex === 3 ? "48px" : "160px", paddingLeft: "24px", paddingRight: "24px" }}>
